...
CRUD приложение для управления задачами в PostgreSQL + многопоточный импорт из файлов
...
- многопоточный импорт задач из JSON файлов
...
3. обновить задачу
4. удалить задачу
5. импортировать задачи из файлов
6. выход
выберите: 1
название: изучить Go
